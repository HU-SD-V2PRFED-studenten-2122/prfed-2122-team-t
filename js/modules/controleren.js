    ...
    render() {
        return html`
            <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        <input value="${this.tentamen.ec}" id="ec-oud" name="ec-oud" class="form-control" type="number" step="0.1">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        <input value="${this.tentamen.nieuwTentamen.weging}" id="weging-nieuw" name="weging-nieuw" class="form-control" type="number" step="0.1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        <input value="${this.tentamen.nieuwTentamen.ec}" id="ec-nieuw" name="ec-nieuw" class="form-control" type="number" step="0.1">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <button class="btn btn-success float-right" id="goedkeuren" @click="${this.goedkeuren}">Goedkeuren</button>
                <button class="btn btn-danger float-right" style="margin-right: 10px;" id="afkeuren" @click="${this.afkeuren}">Afkeuren</button>
            </form>
        `;
    }
